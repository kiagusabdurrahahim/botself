...
cl = LINETCR.LINE()
cl.login(token="EqRK3gxXR1MptEGc5fxb.GkU+Y9XGOkjMYaEG2TzRgW.UjLCAOQvq1CpAThoSfrsZwH29z/plFdS9/R30C5BwLw=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Eqr3ERxVr4G8WS0vmUT1.xNkxtoD+5q7kElXTHQjQCq.Mf+bndUjb13fkAqblzKI8qIqBp+m0zJGnL1dCMweOng=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqHvUbsb42ZWWOjsgfVc.EkxQEuAHrwqh2JXrUG5dda.JZtL96ibBgq2yKO26tVKAGORdR01IE9eWTjV1N357io=")
ki2.loginResult()
...
admin = ["u80abbfcbdc60a0a266c807a0dad66b1b"]
wait = {
    'contact':False,
    'autoJoin':True,
