...
cl = LINETCR.LINE()
cl.login(token="Er4BxDIDWVIDMgzYEx80.mB29r/2AaGd7Fkqz37DKKa.Hl//1jbQWNknE/3er2qfALUtV2C4sHXQccti/FV2Ec8=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Er6HGylI70YhNSvCm5y6.OZZTZ6koi0Evq9IStt/GTG.Yg1dpsvUCufdi2qsPu0Lq89p4nmSPSbvqQKYYFo9/MA=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Err4nRYuk4ouRPSbAnk9.lYTsWAuLReQY6TkdlpTtsq.KAxbppRx1NE4JQ9QGa5Dyf51Q+LLa7862cvfZRYlzjE=")
ki2.loginResult()
...
owner =["u31bdbd47ed9a0200fb7ca419dfb76490"]
admin = ["u31bdbd47ed9a0200fb7ca419dfb76490"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    ...
    #-------------- copy profile----------
                ...
                txt = msg.text.split(" Hai apa kabar semua ")
                jmlh = int(txt[2])
...
#-----------------------------------------------
    ...
    #-------------Tag All Test------------------------#
    #-------------------------------------------------#
            elif msg.text in ["Bot Like", "Like"]:
              #if msg.from_ in admin:
